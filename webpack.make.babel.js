...
export default function makeWebpackConfig(options) {
    ...
    if (TEST) {
        ...
        config.output = {
            ...
            publicPath: BUILD ? '/public/' : 'http://localhost:3000/',

            // Filename for entry points
            // Only adds hash in build mode
            filename: BUILD ? 'javascripts/[name].[hash].js' : '[name].bundle.js',

            // Filename for non-entry points
            // Only adds hash in build mode
            chunkFilename: BUILD ? 'javascripts/[name].[hash].js' : '[name].bundle.js'
        }
    }
